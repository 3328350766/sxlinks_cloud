...
import com.sxlinks.common.util.MD5Util;
...
import com.sxlinks.modules.system.entity.SysRolePermission;
import com.sxlinks.modules.system.model.SysPermissionTree;
import com.sxlinks.modules.system.model.TreeModel;
import com.sxlinks.modules.system.service.*;
import com.sxlinks.modules.system.util.PermissionDataUtil;
...
//	}
	 ...
	 */
		...
		if (permission.getMenuType().equals(CommonConstant.MENU_TYPE_2)) {
			...
			//update-begin--Author:baba  Date:20201015 for：路由缓存问题，关闭了tab页时再打开就不刷新 #842
			...
			//update-end--Author:baba  Date:20201015 for：路由缓存问题，关闭了tab页时再打开就不刷新 #842
