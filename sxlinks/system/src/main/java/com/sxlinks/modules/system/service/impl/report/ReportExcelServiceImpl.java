...
import com.sxlinks.modules.enums.CellType;
import com.sxlinks.modules.enums.ReportTypeEnum;
import com.sxlinks.modules.system.controller.report.utils.GaeaAssert;
import com.sxlinks.modules.system.controller.report.utils.GaeaBeanUtils;
import com.sxlinks.modules.system.entity.report.*;
import com.sxlinks.modules.system.mapper.report.ReportExcelMapper;
...
//    private GaeaFileService gaeaFileService;
    ...
    @Override
    public void copy(ReportExcelDto reportExcelDto) {
        ReportExcel report = getById(reportExcelDto.getId());

                ReportExcel reportExcel = reportExcelMapper.selectOne(new QueryWrapper<ReportExcel>().eq("report_code", reportExcelDto.getReportCode()));
                if (null != reportExcel) {
                    reportExcel.setId(null);
                    reportExcel.setReportCode(DateUtil.getTime()); //以时间命名
...
//    }
    ...
    public ReportExcelDto preview(ReportExcelDto reportExcelDto) {
        // 根据id查询 报表详情
        QueryWrapper<ReportExcel> wrapper = new QueryWrapper();
        wrapper.eq("report_code",reportExcelDto.getReportCode());
        ReportExcel reportExcel = getOne(wrapper);
