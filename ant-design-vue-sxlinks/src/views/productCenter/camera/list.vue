  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: '/productCenter/camera/list',
          delete: '/productCenter/camera/delete',
          deleteBatch: '/productCenter/camera/deleteBatch',
          exportXlsUrl: '/productCenter/camera/exportXls',
          importExcelUrl: 'productCenter/camera/importExcel',
        },
      }
    },
    computed: {
