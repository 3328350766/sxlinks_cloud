    ...
    children: [
      {
        ...
        name: 'viewer',
        meta: {title: '大屏详情'},
        component: resolve => require(['@views/visual/bigscreen/bigscreenDesigner/viewer/index'], resolve),
      },
      {
        path: 'designer',
		component: BlankLayout,
        name: 'designer',
        meta: {title: '大屏编辑'},
        component: resolve => require(['@views/visual/bigscreen/bigscreenDesigner/designer/index'], resolve),
      },
    ]
  },
{
	  path: '/excelReportDesign',
	  component: BlankLayout,
	  hidden: true,
	  children: [
	    {
	      ...
	      name: 'excelPreview',
	      meta: {title: '表格报表预览'},
	      component: resolve => require(['@views/visual/reportExcel/viewer/index'],resolve),
	    },
	    {
	      path: 'excelDesigner',
		  component: BlankLayout,
	      name: 'excelDesigner',
	      meta: {title: '表格报表编辑'},
	      component: resolve => require(['@views/visual/reportExcel/designer/index'],resolve),
	    },
	  ]
	},	
	{
	 ...
	 //      name: 'yuanqu',
	 //      meta: {title: '智慧园区'},
	 //      component: resolve => require(['@views/productCenter/app/yuanqu/views/index'], resolve),
	 //    },
	    // {
	    //   path: 'index',
	    // component: BlankLayout,
	    //   name: 'index',
	    //   meta: {title: '智慧园区'},
	    //   component: resolve => require(['@views/productCenter/app/yuanqu/public/index.html'], resolve),
	    // },
	  ]
	},
  // {
...

  {
	...
	//   component: BlankLayout,
	//   hidden: true,
	//   redirect: '/visual/configure',
	//   children: [
	//     {
	//       path: 'design',
	//       name: 'design',
	//       component: () => import('@/views/visual/configure/design')
	//     }
	//   ]
	// },
  {
