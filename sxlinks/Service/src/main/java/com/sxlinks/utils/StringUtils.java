...
public class StringUtils {
    ...
    public static String getFileExt(String filename){
        String rstr="";
        rstr = filename.substring(filename.lastIndexOf(".") + 1);
        return rstr;
    }
    /**
    ...
    public static boolean isFile(String fileName) {
        // return fileName.matches("[\\s\\S]+.[gif|jpg|png|jpeg|bmp]");
        return fileName.matches("^[\\s\\S]+\\.+(jpg|bmp|swf|png|gif|pdf|apk|word|excel|doc|exe|zip|rar|iso|ppt|wps|lrc|rm|rmvb|xlsx|xls|docx|doc|mp4|mp3|swf|DOC|ppt|rar|dwg|exe|blank|css|js|xml|ico|xps)$");
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("new no:"+StringUtils.getNewOrderNo());
        String str=" <p>�������⡢�����������\u05F7ۡ����顢�Ͼơ��Ρ��С�����</p>";
        str="sfsdfsdfdsf";
        System.out.println("含中文："+haveChinese(str)+ " 是中文:"+allChinese(str));
        System.out.println("随机数："+ new Random().nextInt(3));
        String filename="https://t1.huanqiucdn.cn/b33d43a18fe4df5aa61279a46ddfa96f.jpg";
        if(isPic(filename)){
            System.out.println("图片后缀名为:"+getFileExt(filename));
        }else{
            System.out.println("图片后缀名为:"+".png");
        }
