 ...
 * @Since：   2022-06-02
 */
public interface SummaryAreaEnergyDataHourMapper extends BaseMapper<SummaryAreaEnergyDataHour> {


	@Select("select * from summary_area_energy_data_hour where id=#{summary_electric_device_dataId}")
	...
	@Select("select * from summary_area_energy_data_hour where code=#{code}")
