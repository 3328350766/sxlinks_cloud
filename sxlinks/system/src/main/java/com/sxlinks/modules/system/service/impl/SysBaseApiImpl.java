...
import com.sxlinks.common.api.dto.OnlineAuthDTO;
import com.sxlinks.common.api.dto.message.*;
import com.sxlinks.common.aspect.UrlMatchEnum;
import com.sxlinks.common.constant.CacheConstant;
import com.sxlinks.common.constant.CommonConstant;
import com.sxlinks.common.constant.DataBaseConstant;
import com.sxlinks.common.constant.WebsocketConst;
...
import com.sxlinks.common.system.vo.*;
import com.sxlinks.common.util.SysAnnmentTypeEnum;
import com.sxlinks.common.util.YouBianCodeUtil;
import com.sxlinks.common.util.oConvertUtils;
import com.sxlinks.modules.message.entity.SysMessageTemplate;
import com.sxlinks.modules.message.handle.impl.EmailSendMsgHandle;
import com.sxlinks.modules.message.service.ISysMessageTemplateService;
import com.sxlinks.modules.message.websocket.WebSocket;
import com.sxlinks.modules.system.entity.*;
import com.sxlinks.modules.system.mapper.*;
import com.sxlinks.modules.system.service.*;
import com.sxlinks.modules.system.util.SecurityUtil;
	...
	public List<SysPermissionDataRuleModel> queryPermissionDataRule(String component, String requestPath, String username) {
		...
		if(currentSyspermission!=null && currentSyspermission.size()>0){
			...
			for (SysPermission sysPermission : currentSyspermission) {
				// update-begin--Author:baba Date:20191119 for：数据权限规则编码不规范，项目存在相同包名和类名 #722
				...
				// update-end--Author:baba Date:20191119 for：数据权限规则编码不规范，项目存在相同包名和类名 #722
			}
			return dataRules;
		}
		return null;
