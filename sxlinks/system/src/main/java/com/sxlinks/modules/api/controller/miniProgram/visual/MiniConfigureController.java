 ...
 */
@RestController
@RequestMapping("/miniProgram/visual/configure")
@Slf4j
@Api(value = "可视化", tags = {"组态管理"})
public class MiniConfigureController {
	@Autowired
	...
	public Result<IPage<Configure>> queryPageList(
		...
		if(StringUtils.isNotEmpty(state))configure.setState(state);
