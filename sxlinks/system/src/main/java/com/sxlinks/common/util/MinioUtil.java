...
import com.sxlinks.common.util.filter.StrAttackFilter;
...
public class MinioUtil {
    ...
    public void setUrl(String minio_url) {
        MinioUtil.minioUrl = minio_url;
    }

    @Value("${jeecg.minio.minio_name}")
    public void setName(String minio_name) {
        MinioUtil.minioName = minio_name;
    }

    @Value("${jeecg.minio.minio_pass}")
    public void setPassword(String minio_pass) {
        MinioUtil.minioPass = minio_pass;
    }
    ...
    public static String upload(MultipartFile file, String bizPath, String customBucket) {
        String file_url = "";
        //update-begin-author:baba date:20201012 for: 过滤上传文件夹名特殊字符，防止攻击
        bizPath=StrAttackFilter.filter(bizPath);
        //update-end-author:baba date:20201012 for: 过滤上传文件夹名特殊字符，防止攻击
    ...
    public static void removeObject(String bucketName, String objectName) {
        if (StringUtils.isBlank(bucketName)) {
            bucketName = MinioUtil.bucketName;
        }
        try {
            initMinio(minioUrl, minioName,minioPass);
