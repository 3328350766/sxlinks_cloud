//package com.sxlinks.common.util.dynamic.db;
//
...
//            }
//        } catch (Exception e) {
//            //update-begin--Author:baba  Date:20180320 for：解决问题 - 错误提示sql文件不存在，实际问题是sql freemarker用法错误-----
//            if (e instanceof ParseException) {
//                log.error(e.getMessage(), e.fillInStackTrace());
//                throw new Exception(e);
//            }
//            log.debug("----isExistTemplate----" + e.toString());
//            //update-end--Author:baba  Date:20180320 for：解决问题 - 错误提示sql文件不存在，实际问题是sql freemarker用法错误------
//            return false;
//        }
//        return true;
//    }
