...
public class LoginController {
	...
	public Result<JSONObject> login(@RequestBody SysLoginModel sysLoginModel){
		...
		//update-begin--Author:baba  Date:20190805 for：暂时注释掉密码加密逻辑，有点问题
		//前端密码加密，后端进行密码解密
	...
	public Result<Object> logout(HttpServletRequest request,HttpServletResponse response) {
	    ...
	    if(sysUser!=null) {
			//update-begin--Author:baba  Date:20200714  for：登出日志没有记录人员
			baseCommonService.addLog("用户名: "+sysUser.getRealname()+",退出成功！", CommonConstant.LOG_TYPE_1, null,sysUser);
			//update-end--Author:baba  Date:20200714  for：登出日志没有记录人员
	...
	public Result<String> sms(@RequestBody JSONObject jsonObject) {
		...
		try {
			...
			//update-begin--Author:baba  Date:20190812 for：issues#391
			//result.setResult(captcha);
			//update-end--Author:baba  Date:20190812 for：issues#391
