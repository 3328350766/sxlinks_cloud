...
public class VideoManagerConstants {
	 ...
	 * 移动位置订阅通知
	 */
	public static final String VM_MSG_SUBSCRIBE_MOBILE_POSITION = "video_mobileposition";

	/**
	 * 报警订阅的通知（收到报警向redis发出通知）
	 */
	public static final String VM_MSG_SUBSCRIBE_ALARM = "video_alarm";

	/**
	 * 报警通知的发送 （收到redis发出的通知，转发给其他平台）
	 */
	public static final String VM_MSG_SUBSCRIBE_ALARM_RECEIVE= "video_alarm_receive";

	/**
	 * 设备状态订阅的通知
	 */
	public static final String VM_MSG_SUBSCRIBE_DEVICE_STATUS = "video_device";


	//**************************    第三方  ****************************************

	public static final String WVP_STREAM_GB_ID_PREFIX = "video_memberNo_";
	public static final String WVP_STREAM_GPS_MSG_PREFIX = "video_WVP_STREAM_GPS_MSG_";
