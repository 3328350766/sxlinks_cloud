...
import com.sxlinks.common.constant.CommonSendStatus;
...
import com.sxlinks.modules.system.entity.SysAnnouncement;
import com.sxlinks.modules.system.entity.SysAnnouncementSend;
import com.sxlinks.modules.system.service.ISysAnnouncementSendService;
import com.sxlinks.modules.system.service.ISysAnnouncementService;
import com.sxlinks.modules.system.service.impl.ThirdAppDingtalkServiceImpl;
import com.sxlinks.modules.system.service.impl.ThirdAppWechatEnterpriseServiceImpl;
...
import static com.sxlinks.common.constant.CommonConstant.ANNOUNCEMENT_SEND_STATUS_1;
	...
	public Result<Map<String,Object>> listByUser() {
		...
		if(announcements.size()>0) {
			for(int i=0;i<announcements.size();i++) {
				//update-begin--Author:baba  Date:20200803  for： 通知公告消息重复LOWCOD-759--------------------
				...
				//update-end--Author:baba  Date:20200803  for： 通知公告消息重复LOWCOD-759------------
			}
		}
		// 2.查询用户未读的系统消息
