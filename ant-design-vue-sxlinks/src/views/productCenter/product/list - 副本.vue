<template>
  <a-card :bordered="false">
    ...
    <div class="app-list">
      ...
      >
        <span slot="action" slot-scope="text, record">
		  <a href="javascript:;" @click="detailsClick(record.id, record.productCode)">物模型</a>
    ...
    <!--开始-->
    <!-- 详情弹窗 -->
    <a-modal :width="900" :visible="visible" :confirm-loading="confirmLoading" @ok="handleOk" @cancel="handleCancel">
      <div>
              ...
              <a-tab-pane key="1" tab="属性定义">
                <div class="wrapTab">
                  ...
                  <div class="" v-if="attrPageData">
                    ...
                    >
                      <span slot="action" slot-scope="text, record">
                        <a @click="attrEdit(record)" style="margin-right:5px">编辑</a>
              ...
              <a-tab-pane key="2" tab="功能定义">
                <div class="wrapTab">
                  ...
                  <div class="">
                    ...
                    >
                      <span slot="action" slot-scope="text, record">
                        <a @click="functionEdit(record)" style="margin-right:5px">编辑</a>
