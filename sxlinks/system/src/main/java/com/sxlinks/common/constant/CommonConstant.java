package com.sxlinks.common.constant;
...
public interface CommonConstant {
    ...
    /** 登录用户Shiro权限缓存KEY前缀 */
    public static String PREFIX_USER_SHIRO_CACHE  = "shiro:cache:com.sxlinks.config.shiro.ShiroRealm.authorizationCache:";
    /** 登录用户Token令牌缓存KEY前缀 */
    public static final String PREFIX_USER_TOKEN  = "prefix_user_token_";
    public static final String PREFIX_MINI_USER_TOKEN  = "prefix_mini_user_token";
    /** Token缓存时间：3600秒即一小时 */
