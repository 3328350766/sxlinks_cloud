...
import com.sxlinks.modules.system.model.DepartIdModel;
import com.sxlinks.modules.system.model.SysUserSysDepartModel;
import com.sxlinks.modules.system.service.*;
import com.sxlinks.modules.system.vo.SysDepartUsersVO;
import com.sxlinks.modules.system.vo.SysUserRoleVO;
...
public class SysUserController {
     ...
     * @return
     */
    @ApiOperation(value = "获取指定部门用户")
    @RequestMapping(value = "/getUserByDepId", method = RequestMethod.GET)
    public Result<IPage<SysUser>> queryPageList(@RequestParam(name="deptId") String deptId,
        ...
        Result<IPage<SysUser>> result = new Result<IPage<SysUser>>();
        Page<SysUser> page = new Page<SysUser>(pageNo, pageSize);
        IPage<SysUser> pageList = sysUserService.getUserByDepId(page, deptId,username);
        result.setSuccess(true);
        result.setResult(pageList);
        log.info(pageList.toString());
        return result;
