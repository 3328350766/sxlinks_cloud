...
import com.sxlinks.modules.system.mapper.report.ReportDashboardMapper;
...
import com.sxlinks.modules.system.util.DateUtil;
...
@Service
@Slf4j
public class ReportDashboardServiceImpl extends ServiceImpl<ReportDashboardMapper,ReportDashboard> implements ReportDashboardService {
...
//    private GaeaFileService gaeaFileService;
    ...
    public ReportDashboardObjectDto getDetail(String reportCode) {
        ...
        LambdaQueryWrapper<ReportDashboard> queryWrapper = new LambdaQueryWrapper();
        queryWrapper.eq(ReportDashboard::getReportCode,reportCode);
        ReportDashboard reportDashboard = getOne(queryWrapper);
