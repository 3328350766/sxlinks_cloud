    ...
    <el-container v-loading="loading" style="height: 91vh;" element-loading-text="拼命加载中">
      ...
      <el-container class="containers">
        ...
        <el-main style="padding: 0;">
          <div style="width: 78%;height: 85vh;display: flex;flex-wrap: wrap;background-color: #000;">
...
<script>
import player from '@comp/common/jessibuca.vue'
import DeviceTree from '@comp/common/DeviceTree.vue'
import { getPlay } from '@/api/product'
...
export default {
  ...
  methods: {
    ...
    sendDevicePush: function (itemData) {
      ...
      let that = this;
      this.loading = true
      let url=Vue.prototype.VIDEO_BASE_URL+`/api/play/start/${deviceId}/${channelId}`
      ...
      // getPlay(`/video/play/start/${deviceId}/${channelId}`).then((res)=>{
      //   if (res.data.code === 0 && res.data.data) {
      //     itemData.playUrl = res.data.data.httpsFlv
      //     that.setPlayUrl(res.data.data.ws_flv, idxTmp)
      //   } else {
