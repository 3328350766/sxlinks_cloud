...
import com.sxlinks.common.constant.FillRuleConstant;
import com.sxlinks.common.util.FillRuleUtil;
...
import com.sxlinks.modules.system.model.SysDepartTreeModel;
import com.sxlinks.modules.system.service.ISysDepartService;
import com.sxlinks.modules.system.util.FindsDepartsChildrenUtil;
...
public class SysDepartServiceImpl extends ServiceImpl<SysDepartMapper, SysDepart> implements ISysDepartService {
	...
	private String[] generateOrgCode(String parentId) {	
		//update-begin--Author:baba  Date:20190201 for：组织机构添加数据代码调整
				LambdaQueryWrapper<SysDepart> query = new LambdaQueryWrapper<SysDepart>();
				...
				strArray[1] = orgType;
				return strArray;
		//update-end--Author:baba  Date:20190201 for：组织机构添加数据代码调整
	} 
