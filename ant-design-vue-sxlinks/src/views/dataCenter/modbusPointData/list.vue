  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: '/dataCenter/product/list',
          delete: '/dataCenter/product/delete',
          deleteBatch: '/dataCenter/product/deleteBatch',
          exportXlsUrl: '/dataCenter/product/exportXls',
          importExcelUrl: 'dataCenter/product/importExcel',
        },
      }
    },
    computed: {
