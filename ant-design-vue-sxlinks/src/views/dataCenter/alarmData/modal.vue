    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item
          ...
          required
          label="产品编码">
          <a-input placeholder="请输入产品编码" v-model="model.code" :read-only="readOnly"/>
        </a-form-model-item>
        <a-form-model-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          ...
          required
          label="产品名称">
          <a-input placeholder="请输入产品名称" v-model="model.name"/>
        </a-form-model-item>
        <a-form-model-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          add: '/productCenter/alarmData/add',
          edit: '/productCenter/alarmData/edit',
        },
        readOnly:false
      }
    },
