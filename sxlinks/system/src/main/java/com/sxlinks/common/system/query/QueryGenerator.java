package com.sxlinks.common.system.query;
...
public class QueryGenerator {
	...
	public static void doMultiFieldsOrder(QueryWrapper<?> queryWrapper,Map<String, String[]> parameterMap) {
		...
		if (oConvertUtils.isNotEmpty(column) && oConvertUtils.isNotEmpty(order)) {
			...
			//update-begin--Author:baba  Date:20210531 for：36 多条件排序无效问题修正-------
			// 排序规则修改
			...
			//update-end--Author:baba  Date:20210531 for：36 多条件排序无效问题修正-------
		}
	}
	...
	private static QueryRuleEnum convert2Rule(Object value) {
		...
		//update-begin--Author:baba  Date:20190724 for：initQueryWrapper组装sql查询条件错误 #284-------------------
		...
		//update-end--Author:baba  Date:20190724 for：initQueryWrapper组装sql查询条件错误 #284---------------------
